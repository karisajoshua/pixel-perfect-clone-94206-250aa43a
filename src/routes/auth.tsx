...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — Zest Insurance" },
      { name: "description", content: "Sign in to the Zest Insurance Agency workspace." },
    ],
  }),
  component: AuthPage,
});
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      <div className="hidden lg:flex flex-col justify-between p-12 bg-sidebar text-sidebar-foreground">
        ...
        <p className="text-xs text-sidebar-foreground/50">© {new Date().getFullYear()} Zest Insurance Agency</p>
      </div>
